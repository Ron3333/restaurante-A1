<?php 
    ...
    define("APPURL", "http://restaurante.test");
    define("APPIMAGES", "http://restaurante.test/admin-panel/foods-admins/foods-images" );
                    ...
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <li><a class="dropdown-item" href="<?php echo APPURL; ?>/users/review.php">Reviews</a></li>
